...
Sound, bot count, bot difficulty, attract mode, and tuning sliders are available on the setup screen. Bots fill the highest-numbered player slots, attract mode starts a bot demo while idle, and tuning adjusts turn rate, thrust, and shot speed. Bot difficulty changes reaction time, aim error, leading, fire discipline, gravity avoidance, and trick-shot appetite. Revenge mode makes bots prefer the human player who last killed them. Bastard difficulty is automatically vindictive and can prefer awkward wraparound or star-skimming shot lanes.
